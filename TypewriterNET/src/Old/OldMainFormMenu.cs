...
{
	public class OldMainFormMenu : MainMenu
	{
		...
		public OldMainFormMenu(TabInfoList fileList)
		{
		...
		{
			private OldMainFormMenu menu;
			private string name;
			private bool isOther;

			public DynamicMenuItem(OldMainFormMenu menu, string name, bool isOther) : base(name)
			{
				this.name = name;
				this.menu = menu;
