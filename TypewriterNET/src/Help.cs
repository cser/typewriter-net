...
public static class Help
{
	...
	public static Buffer NewHelpBuffer(Settings settings, Commander commander)
	{
		...
		builder.AppendLine("		%Y - full year, i.e. 2017");
		builder.AppendLine("		%m - month, i.e. 09");
		builder.AppendLine("		%d - day, i.e. 05");
		builder.AppendLine("		%H - hours, i.e. 14");
		builder.AppendLine("		%M - minutes, i.e. 48");
		builder.AppendLine("		%S - seconds, i.e. 34");
		builder.AppendLine("		%a - week day, i.e. Tue");
		builder.AppendLine("		%A - full week day, i.e. Tuesday");
		builder.AppendLine("		%b - month, i.e. Sep");
		builder.AppendLine("		%B - full month, i.e. September");
