...
namespace UnitTests
{
	...
	{	
		...
		public void Match1()
		{
			RERegex regex = new RERegex(@"ab");
			Assert.AreEqual(new REMatch(4, 2), regex.Match("xxxxabxxx"));
			Assert.AreEqual(new REMatch(3, 2), regex.Match("xxxabxxxabx"));
		}
		...
		public void Match2()
		{
			RERegex regex = new RERegex(@"ab");
			Assert.AreEqual(new REMatch(4, 2), regex.Match("xxxxabxxx"));
			Assert.AreEqual(new REMatch(-1, -1), regex.Match("xxxbxxx"));
		}
