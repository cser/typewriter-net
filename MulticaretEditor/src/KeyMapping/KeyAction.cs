...
namespace MulticaretEditor
{
	public class KeyAction
	{
		...
		public static readonly KeyAction LowerCase = Add("&Edit\\Text\\Lower case", DoLowerCase, null, true);
		private static bool DoLowerCase(Controller controller)
		{
			controller.ChangeCase(false);
			return true;
		}

		public static readonly KeyAction UpperCase = Add("&Edit\\Text\\Upper case", DoUpperCase, null, true);
		private static bool DoUpperCase(Controller controller)
		{
		...
		{
			controller.ScrollRelative(0, -controller.Lines.scrollingStep);
			return true;
		}
