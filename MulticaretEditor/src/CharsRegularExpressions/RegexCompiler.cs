    ...
    internal abstract class RegexCompiler {
        ...
        static RegexCompiler() {
            ...
            try {
                ...
                _chartolowerM   = typeof(char).GetMethod("ToLower", new System.Type[] {typeof(char), typeof(CultureInfo)});
                //_getcharM       = typeof(string).GetMethod("get_Chars", new System.Type[] {typeof(int)});
        ...
        internal static void CompileToAssembly(RegexCompilationInfo[] regexes, AssemblyName an, CustomAttributeBuilder[] attribs, string resourceFile) {
            ...
            for (int i=0; i<regexes.Length; i++) {
                if (regexes[i] == null) {
                    throw new System.ArgumentNullException("regexes", SR.GetString(SR.ArgumentNull_ArrayWithNullElements));
                }
                ...
                System.TimeSpan mTimeout = regexes[i].MatchTimeout;
        ...
        internal void MONKEY_Ldelem_I2() {
        	_ilg.Emit(OpCodes.Ldelem_I2);
        }
        ...
        internal void Rightchar() {
            Ldloc(_textV);
            Ldloc(_textposV);
            MONKEY_Ldelem_I2();//Callvirt(_getcharM);
        }
...
#pragma warning restore 219
                ...
                default:
                    throw new System.NotImplementedException(SR.GetString(SR.UnimplementedState));
            }
        }
    }
    ...
    internal class RegexTypeCompiler : RegexCompiler {
        ...
        internal RegexTypeCompiler(AssemblyName an, CustomAttributeBuilder[] attribs, string resourceFile) {
            ...
            try {
                ...
                ConstructorInfo transparencyCtor = typeof(SecurityTransparentAttribute).GetConstructor(System.Type.EmptyTypes);
                ...
                _assembly = System.AppDomain.CurrentDomain.DefineDynamicAssembly(an, AssemblyBuilderAccess.RunAndSave, assemblyAttributes);
         ...
         */
        internal System.Type FactoryTypeFromCode(RegexCode code, RegexOptions options, string typeprefix) {
        ...
        internal void GenerateRegexType(string pattern, RegexOptions opts, string name, bool ispublic, RegexCode code, RegexTree tree, System.Type factory, System.TimeSpan matchTimeout) {
            ...
            System.Type[] noTypeArray                = new System.Type[0];
            ...
            DefineType(name, ispublic, typeof(Regex));
            {
                ...
                _ilg = defCtorBuilder.GetILGenerator();
                {
                    ...
                    _ilg.Emit(OpCodes.Call, typeof(Regex).GetConstructor(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance,
                                                                         null, new System.Type[0], new ParameterModifier[0]));
                    // set pattern
                    Ldthis();
                    Ldstr(pattern);
                    Stfld(patternF);
                    ...
                    Call(typeof(System.TimeSpan).GetMethod("FromTicks", BindingFlags.Static | BindingFlags.Public));
                    ...
                    if (code._caps != null)
#if SILVERLIGHT
                        GenerateCreateType(typeof(Dictionary<int, int>), capsF, code._caps);
#else
...
#if SILVERLIGHT
                        GenerateCreateType(typeof(Dictionary<string, int>), capnamesF, tree._capnames);
#else
                ...
                tmoutCtorBuilder = _typebuilder.DefineConstructor(ma, CallingConventions.Standard, new System.Type[] { typeof(System.TimeSpan) });
        ...
        internal void GenerateCreateHashtable(FieldInfo field, Hashtable ht) {
            ...
            Ldthis();
            Newobj(typeof(Hashtable).GetConstructor(new System.Type[0]));
#endif
         ...
         */
        internal void GenerateCreateInstance(System.Type newtype) {
            Newobj(newtype.GetConstructor(new System.Type[0]));
            Ret();
        }
         ...
         */
        internal void DefineType(string typename, bool ispublic, System.Type inheritfromclass) {
            if (ispublic)
         ...
         */
        internal void DefineMethod(string methname, System.Type returntype) {
         ...
         */
        internal System.Type BakeType() {
            System.Type retval = _typebuilder.CreateType();
            _typebuilder = null;
    ...
    internal class RegexLWCGCompiler : RegexCompiler {
        ...
        private static System.Type[] _paramTypes = new System.Type[] {typeof(RegexRunner)};
         ...
         * Begins the definition of a new method (no args) with a specified return value
         */
        internal DynamicMethod DefineDynamicMethod(string methname, System.Type returntype, System.Type hostType) {
