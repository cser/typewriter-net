    ...
    internal sealed class RegexCharClass {
        ...
        ***************************************************************************/
        ...
        static RegexCharClass() {
            ...
            System.Text.StringBuilder word = new System.Text.StringBuilder(11);
        ...
        internal RegexCharClass() {
            ...
            _canonical = true;
            _categories = new System.Text.StringBuilder();

        }

        private  RegexCharClass(bool negate, List<SingleRange> ranges, System.Text.StringBuilder categories, RegexCharClass subtraction) {
            _rangelist = ranges;
        ...
        internal static string ConvertOldStringsToClass(string set, string category) {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(set.Length + category.Length + 3);
        ...
        */
        ...
        private static string NegateCategory(string category) {
            ...
            System.Text.StringBuilder sb = new System.Text.StringBuilder(category.Length);
        ...
        private static RegexCharClass ParseRecursive(string charClass, int start) {
            ...
            return new RegexCharClass(charClass[start+FLAGS] == 1, ranges, new System.Text.StringBuilder(charClass.Substring(end, myCategoryLength)), sub);
        }
        ...
        internal string ToStringClass() {
            ...
            System.Text.StringBuilder sb = new System.Text.StringBuilder(rangeLen + _categories.Length + 3);
        ...
        private static string SetFromProperty(string capname, bool invert, string pattern) {
            ...
            while (min != max) {
                int mid = (min + max) / 2;
                int res = string.Compare(capname, _propTable[mid,0], System.StringComparison.Ordinal);
                if (res < 0)
                    max = mid;
                else if (res > 0)
                    min = mid + 1;
            ...
            throw new System.ArgumentException(SR.GetString(SR.MakeException, pattern, SR.GetString(SR.UnknownProperty, capname))); 
        }
