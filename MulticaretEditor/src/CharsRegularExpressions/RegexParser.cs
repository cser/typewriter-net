...
/*                        name = */ ScanCapname();
            ...
            if (_capnames != null || _capnumlist != null) {
                ...
                for (int i = 0; i < _capcount; i++) {
                    ...
                    if (next == j) {
                        ...
                        string str = System.Convert.ToString(j, _culture);
        ...
        */
         ...
         */
        internal System.ArgumentException MakeException(string message) {
            return new System.ArgumentException(SR.GetString(SR.MakeException, _pattern, message));
        }
