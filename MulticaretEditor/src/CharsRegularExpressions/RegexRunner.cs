...
namespace CharsRegularExpressions {
    ...
    abstract public class RegexRunner {
        ...
        protected internal char[] runtext;          // text to search
...
*/
        ...
        private void StartTimeoutWatch() {
            ...
            // in DoCheckTimeout():
            unchecked {
                timeoutOccursAt = System.Environment.TickCount + timeout;
            }
        }
        ...
        private void DoCheckTimeout() {
            ...
            int currentMillis = System.Environment.TickCount;
            ...
            throw new RegexMatchTimeoutException("runtext", runregex.pattern, System.TimeSpan.FromMilliseconds(timeout));
        }
