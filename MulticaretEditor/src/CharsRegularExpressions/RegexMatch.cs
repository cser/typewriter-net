...
namespace CharsRegularExpressions {
    ...
    public class Match : Group {
         ...
         */
        internal Match(Regex regex, int capcount, char[] text, int begpos, int len, int startpos)
         ...
         */
        internal virtual void Reset(Regex regex, char[] text, int textbeg, int textend, int textstart) {
            _regex = regex;
            _text = text;
            _textbeg = textbeg;
            _textend = textend;
        ...
        static internal Match Synchronized(Match inner) {
            ...
            for (int i = 0; i < numgroups; i++) {
                ...
                CharsRegularExpressions.Group.Synchronized(group);
            }
