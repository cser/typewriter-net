...
namespace MulticaretEditor
{
	public class ClipboardExecuter
	{
		...
		private static PcreRegex _viRegex;
		public static PcreRegex ViRegex { get { return _viRegex; } }
		
		private static PcreRegex _viBackwardRegex;
		public static PcreRegex ViBackwardRegex { get { return _viBackwardRegex; } }
			...
			else if (c == '/')
			{
				...
				else
				{
					try
					{
						...
						_viRegex = new PcreRegex(text, options);
						_viBackwardRegex = new PcreRegex(text, PcreOptions.NONE | options);
					}
					catch
					{
						_viRegex = null;
